...
class BottomSheetOnlyCardView extends StatelessWidget {
  ...
  const BottomSheetOnlyCardView({
    ...
    this.skipTextStyle = const TextStyle(fontWeight: FontWeight.w500),
