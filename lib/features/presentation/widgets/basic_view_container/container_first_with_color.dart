...
class ContainerColorFirst extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //Set status bar and bottom sef area color
    appBackgroundColor =
        !isDarkMode ? AppColors.appBgColor5 : AppColors.appBgColor4;
            ...
            ? Column(
                children: [
                  isOverLayStatusBar
                      ...
                      : OtpStatusBar(statusBarColor: statusBarColor),
                  isOverLayAppBar
                      ? Container()
                      : AppBarView(
                          appBar: appBar,
