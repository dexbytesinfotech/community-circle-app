class GuestProfileModel {
  GuestProfileData? data;
  String? message;

  GuestProfileModel({this.data, this.message});

  GuestProfileModel.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new GuestProfileData.fromJson(json['data']) : null;
...
class GuestProfileData {
  ...
  GuestProfileData.fromJson(Map<String, dynamic> json) {
    name = json['name'];
