class GuestOtpVerifyModel {
  GuestOtpVerifyData? data;
  String? message;

  GuestOtpVerifyModel({this.data, this.message});

  GuestOtpVerifyModel.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new GuestOtpVerifyData.fromJson(json['data']) : null;
...
class GuestOtpVerifyData {
  ...
  GuestOtpVerifyData.fromJson(Map<String, dynamic> json) {
    name = json['name'];
