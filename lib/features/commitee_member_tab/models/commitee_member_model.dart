...
class CommitteeMember {
  List<CommitteeMembersList>? data;
  String? message;
  Pagination? pagination;

  CommitteeMember({this.data, this.message, this.pagination});

  CommitteeMember.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <CommitteeMembersList>[];
      json['data'].forEach((v) {
        data!.add(new CommitteeMembersList.fromJson(v));
      });
    }
...
class CommitteeMembersList {
  ...
  CommitteeMembersList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
