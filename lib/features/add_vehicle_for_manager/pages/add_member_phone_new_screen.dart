...
import 'add_member_by_manager.dart';

class AddMemberPhoneNumberScreen extends StatefulWidget {
  final String? houseId;
  const AddMemberPhoneNumberScreen({super.key, this.houseId});

  @override
  State<AddMemberPhoneNumberScreen> createState() => _AddMemberPhoneNumberScreenState();
}

class _AddMemberPhoneNumberScreenState extends State<AddMemberPhoneNumberScreen> {
  ...
  nextButton(state) {
    return Container(
        ...
        child: AppButton(
          ...
          backCallback:controllers['phoneNumber']?.text.length != 10?null:() {
