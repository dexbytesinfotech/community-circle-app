...
abstract class AppColors {
  static const Color appBlueColor = Color(0xff195C9D);
  static const Color lightBlueColor = Color(0xff4A90E2);
  static const Color lighterBlueColor = Color(0xff2B6BB0);
  ...
  static const Color orange = Color.fromARGB(255, 237, 83, 6);
  ...
  static const Color spotlightCardBg = Color(0xFFF9F9F9);
  ...
  static const Color loaderColor2 = Color(0xff195C9D);
  ...
  static const Color appGreenCommonColors = Color(0xFF4CAF50);
  ...
  static const Color textBlueColor = Color(0xff195C9D);
  static const Color textDarkGreenColor = Color(0xFF007200);
  static const Color textDarkRedColor = Color(0xFFb30000);
  static const Color notificationPermissionBgColor = Color(0xFFdae6f7);
  static const Color appOrangeColor = Color(0xFFE77A37);


}
// appTextStyle.noDataTextStyle()
//appTextStyle.errorTextStyle()
